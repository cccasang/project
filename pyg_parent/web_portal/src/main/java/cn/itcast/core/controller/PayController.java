...
public class PayController {
    ...
    public Map<String,String>  createNative(){
        ...
        //3.根据支付日志对象的支付单号和总金额,调用微信统一下单接口生成支付链接
        if (payLog != null){
//            payService.createNative(payLog.getOutTradeNo(),String.valueOf(payLog.getTotalFee()));
